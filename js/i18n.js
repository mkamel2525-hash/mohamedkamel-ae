...
(function () {
  ...
  var DICT = {
    ar: {
      ...
      'hero.wa': 'واتساب فيكتوريا', 'hero.book': 'احجز استشارة خاصة',
      ...
      'about.lead': 'فيكتوريا إيفانوفا مستشارة عقارية استراتيجية — وليست مجرد بائعة — تساعد المستثمرين على بناء محافظ عقارية متميّزة وتنميتها وإدارتها في دبي وأبوظبي.',
      ...
      'dev.pricing': 'أسعار بداية وخطط سداد استرشادية — تأكّد من الأحدث مع فيكتوريا.',
      ...
      'consult.lead': 'تبدأ كل علاقة بمحادثة سرّية. شاركنا أهدافك وسترد عليك فيكتوريا شخصياً.',
      ...
      'footer.copy': 'فيكتوريا إيفانوفا. جميع الحقوق محفوظة.',
    ...
    ru: {
      ...
      'hero.wa': 'WhatsApp Виктории', 'hero.book': 'Записаться на консультацию',
      ...
      'about.lead': 'Виктория Иванова — стратегический консультант по недвижимости, а не продавец. Она помогает инвесторам создавать, развивать и управлять премиальными портфелями в Дубае и Абу-Даби.',
      ...
      'dev.pricing': 'Ориентировочные стартовые цены и планы оплаты — уточняйте актуальные у Виктории.',
      ...
      'consult.lead': 'Любое сотрудничество начинается с конфиденциального разговора. Расскажите о ваших целях, и Виктория ответит лично.',
      ...
      'footer.copy': 'Виктория Иванова. Все права защищены.',
