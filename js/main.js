...
(function () {
  ...
  const developers = [
    { name: 'Emaar', pos: 'Master Developer', positioning: 'The benchmark for iconic, large-scale destinations.', community: 'Downtown Dubai, Dubai Hills, Dubai Creek Harbour.', thesis: 'Blue-chip stability with consistent capital appreciation and liquidity.',
      launches: [ {n:'Creek Haven', a:'Dubai Creek Harbour', t:'1, 2 & 3-bed waterfront apartments', price:'From AED 1.8M', plan:'80/20', ho:'', details:['1, 2 & 3-bedroom apartments','Dual-tower waterfront community','Payment plan synced to construction','~AED 2,410–2,500 / sq ft']}, {n:'Creek Bay', a:'Dubai Creek Harbour', t:'1, 2 & 3-bed waterfront apartments', price:'From AED 1.8M', plan:'80/20', ho:'', details:['1, 2 & 3-bedroom apartments','Payment: 10% on booking + staged 10% instalments','Part of the Creek Beach waterfront district']}, {n:'The Valley — Lillia', a:'Dubailand', t:'Townhouses & villas', price:'From AED 2.0M', plan:'90/10', ho:'Q1 2027'}, {n:'Emaar South — Fairway Villas 2', a:'Dubai South', t:'Villas', price:'From AED 3.2M', plan:'85/15', ho:'Q4 2026'} ] },
    ...
    { name: 'Nakheel', pos: 'Iconic Waterfront', positioning: 'Creator of Dubai’s most iconic man-made destinations.', community: 'Palm Jumeirah, Palm Jebel Ali, Dubai Islands.', thesis: 'Landmark waterfront communities with enduring global prestige.',
      launches: [ {n:'Palm Central Private Residences', a:'Palm Jebel Ali', t:'Beachfront apartments, townhouses & penthouses (1–5 BR)', price:'From AED 2.5M', plan:'20/50/30', ho:'Aug 2029', details:['1-bed apartment — from AED 2.5M','2-bed apartment — from AED 4.26M','3-bed residence — from AED 7.51M','4-bed apartment — from AED 12.62M','5-bed apartment — from AED 17.58M','4-bed townhouse — from AED 14.18M','5-bed penthouse — from AED 31.81M']}, {n:'Palm Jebel Ali Villas', a:'Palm Jebel Ali', t:'Beachfront villas (5–7 BR)', price:'From AED 18M', plan:'80/20', ho:'2029'}, {n:'Bay Villas', a:'Dubai Islands', t:'Villas & townhouses', price:'From AED 4M', plan:'80/20', ho:'Q2 2027'}, {n:'Como Residences', a:'Palm Jumeirah', t:'Ultra-luxury apartments', price:'On request', plan:'Flexible', ho:''} ] },
