/* ============================================================
   SARA KAMEL — luxury motion & interaction layer
   ============================================================ */
(function () {
  'use strict';
  ...
  const developers = [
    ...
    { name: 'Meraas', pos: 'Lifestyle Master Developer', positioning: 'Creator of Dubai’s most vibrant lifestyle destinations.', community: 'City Walk, Bluewaters, Design District (d3), Port de La Mer, La Mer.', thesis: 'Destination-led communities with strong rental demand and a lasting lifestyle premium.',
      launches: [ {n:'Solaya', a:'La Mer, Jumeirah', t:'4–5 BR waterfront villas & grand penthouses', price:'From AED 13.8M', plan:'60/40', ho:'Q3 2029', details:['Ultra-premium 4–5 BR waterfront villas & grand penthouses — from AED 13.8M','Starting price — AED 13,800,000','Plan: 20% on booking · 40% during construction · 40% on handover','Handover: Q3 2029','Ultra-exclusive private seafront enclave on La Mer, Jumeirah']}, {n:'The Edit at d3', a:'Dubai Design District (d3)', t:'1–4 BR urban apartments & luxury penthouses', price:'From AED 2.0M', plan:'75/25', ho:'Jun 2030', details:['1–4 BR urban apartments & luxury penthouses — from AED 2,000,000','Plan: 20% on booking · 55% during construction (10% instalments) · 25% on handover','Handover: June 2030','Iconic tower within the 18M sq ft Dubai Design District Waterfront Masterplan']}, {n:'City Walk Crestlane', a:'Al Wasl, City Walk', t:'1–4 BR apartments & duplexes', price:'From AED 2.62M', plan:'75/25', ho:'Late 2028 – Mid 2029', details:['Modern 1–4 BR apartments & duplexes — from AED 2,620,000','Plan: 20% on booking · 55% during construction · 25% on handover','Handover: late 2028 to mid-2029','Pedestrian-friendly mid-rise towers facing lush urban parks']} ] },
    ...
    function renderDevs() {
      ...
      developers.forEach((d, i) => {
        ...
        const wa = 'https://wa.me/971588801766?text=' +
          encodeURIComponent('Hi Sara, please share the latest ' + d.name + ' launches with current prices and payment plans.');
        card.innerHTML = `
          ${logo}
          ...
          <div class="dev-card__body">
            ...
            <div class="dev-card__launches">
              ...
              <ul>${launches}</ul>
              <p class="dev-card__pricing" data-i18n="dev.pricing">Indicative starting prices &amp; payment plans — confirm the latest with Sara.</p>
  ...
  const LEAD_EMAIL_ENDPOINT = 'https://formsubmit.co/Sara@Deluxehomes.ae';
  form?.addEventListener('submit', (e) => {
    ...
    // 2) WhatsApp message — client taps send and Sara receives it instantly.
    ...
    form.innerHTML = `
      <div style="grid-column:1/-1;text-align:center;padding:2rem 0;">
        ...
        <p style="color:var(--soft);max-width:42ch;margin:0 auto 1.6rem;">Your request has been sent to Sara by email. To confirm on WhatsApp too, tap below — she will respond personally.</p>
...
(function () {
  ...
  function calc() {
    ...
    const msg = encodeURIComponent('Hi Sara, I used the holiday-home calculator (property value AED ' +
