...
(function () {
  ...
  const developers = [
    ...
    { name: 'Select Group', pos: 'Premium Waterfront', positioning: 'Award-winning premium developer of landmark Dubai waterfront residences.', community: 'Dubai Marina, Business Bay, Dubai Maritime City.', thesis: 'Design-led high-rises in prime waterfront districts with strong rental demand and resale liquidity.',
      launches: [ {n:'Six Senses Residences Dubai Marina', a:'Dubai Marina', t:'2–4 BR branded residences', price:'From AED 5.76M', plan:'20/20/60', ho:'Q3 2028', details:['2–4 BR Six Senses-branded residences — from AED 5.76M','Plan: 20% booking · 20% during construction · 60% on handover','Wellness-led branded living in the heart of Dubai Marina','Handover: Q3 2028']}, {n:'Nautica One', a:'Dubai Maritime City', t:'1–2 BR waterfront apartments', price:'From AED 1.57M', plan:'20/20/60', ho:'Q4 2026', details:['1–2 BR apartments — from AED 1.57M','Plan: 20% booking · 20% during construction · 60% on handover','Waterfront tower in Dubai Maritime City','Handover: Q4 2026']}, {n:'Nautica Two', a:'Dubai Maritime City', t:'1–2 BR waterfront apartments', price:'From AED 1.68M', plan:'20/20/60', ho:'Q4 2026', details:['1–2 BR apartments — from AED 1.68M','Plan: 20% booking · 20% during construction · 60% on handover','Sister tower to Nautica One on the Maritime City waterfront','Handover: Q4 2026']} ] },
    { name: 'Zaya', pos: 'Nature-Infused Luxury', positioning: 'The visionary team behind the iconic, nature-infused Al Barari — creators of green, low-density luxury communities.', community: 'Sheikh Zayed Road South, Jebel Ali Village / Saih Shuaib.', thesis: 'Ultra-luxury, greenery-led master communities with scarcity value and strong end-user appeal.',
      launches: [ {n:'Lunaya by Zaya', a:'Jebel Ali Village / Saih Shuaib', t:'4–5 BR townhouses & villas', price:'From AED 4.9M', plan:'40/60 or 35/65', ho:'Q4 2029', details:['The Bloom — 4-BR townhouses (~2,966–3,800 sq ft) — from AED 4.9M','The Rise — 4-BR maisonettes / terraces (~3,814 sq ft) — from AED 6.9M','Semi-detached villas — 5-BR (~6,600+ sq ft) — from AED 12.0M','Standalone waterfront villas — 5-BR (up to 8,231 sq ft) — from AED 16.5M','Plan: 10% down (+4% DLD) · 25–30% during construction · 60–65% on handover','~500–564 residences · 65% green space · 900,000 sq ft swimmable crystal lagoon','Handover: Q4 2029 · all units exceed AED 2M → 10-year Golden Visa']} ] },
    ...
    { name: 'wasl', pos: 'Government-Backed Master Developer', positioning: 'One of Dubai’s largest landlords and master developers — a wasl Asset Management Group company.', community: 'Al Kifaf (Bur Dubai), Wasl Gate, Jumeirah Golf Estates, Al Wasl.', thesis: 'Government-backed, centrally-located communities with reliable demand and strong end-user appeal.',
      launches: [ {n:'Park Views Residences', a:'Al Kifaf, Bur Dubai', t:'1–4 BR apartments', price:'From AED 1.4M', plan:'40/60', ho:'Q4 2026', details:['1–4 BR apartments — from AED 1.4M','Plan: 40% during construction · 60% on handover','Central Bur Dubai — beside Zabeel Park & the Museum of the Future','Towers A & B · handover Q4 2026 – Q1 2027']}, {n:'Ashwood Estates', a:'Jumeirah Golf Estates', t:'4–6 BR ultra-luxury villas', price:'On request', plan:'Flexible', ho:'2027+', details:['185 ultra-luxury 4, 5 & 6-bedroom standalone villas','Private gardens, pools, terraces & in-unit elevators','Set within the expansion of Jumeirah Golf Estates','Spacious layouts, high ceilings & natural materials']}, {n:'South Garden', a:'Wasl Gate', t:'Studio–3 BR apartments', price:'From AED 550K', plan:'60/40', ho:'Q4 2027', details:['Studio–3 BR apartments — from AED 550K','Plan: 60% during construction · 40% on handover','Green community at Wasl Gate near Ibn Battuta Mall & metro','Accessible entry point with strong rental demand']} ] }
  ];
