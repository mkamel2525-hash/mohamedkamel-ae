...
(function () {
  ...
  const developers = [
    ...
    { name: 'Meraas', pos: 'Lifestyle Master Developer', positioning: 'Creator of Dubai’s most vibrant lifestyle destinations.', community: 'City Walk, Bluewaters, Design District (d3), Port de La Mer, La Mer.', thesis: 'Destination-led communities with strong rental demand and a lasting lifestyle premium.',
      launches: [ {n:'Central Park at City Walk', a:'City Walk', t:'1–4 BR apartments (park-side)', price:'From AED 1.99M', plan:'10/40/50', ho:'Q1 2026', details:['Towers: Castleton, Myrtle, Celadon & Viridian','1–4 BR apartments — from AED 1.99M','Plan: 10% down · 40% during construction · 50% on handover','Overlooking a central park in the heart of City Walk']}, {n:'Design Quarter at d3', a:'Dubai Design District (d3)', t:'1–3 BR lofts, duplexes & penthouses', price:'From AED 1.87M', plan:'60/40', ho:'Q2 2027', details:['1–3 BR lofts, duplexes & penthouses — from AED 1.87M','Plan: 20% booking · 40% during construction · 40% on completion','Creative-district living in Dubai Design District']}, {n:'Fern at Central Park', a:'City Walk', t:'Apartments & townhouses', price:'From AED 1.49M', plan:'50/50', ho:'Q1 2026', details:['Urban-green apartments & townhouses — from AED 1.49M','Plan: 50% during construction · 50% on handover','Park-front living within Central Park, City Walk']} ] },
