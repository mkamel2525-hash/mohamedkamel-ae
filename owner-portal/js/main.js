    ...
    function renderDevs() {
      ...
      developers.forEach((d, i) => {
        ...
        const wa = 'https://wa.me/971588801766?text=' +
          encodeURIComponent('Hello, please share the latest ' + d.name + ' launches with current prices and payment plans.');
        card.innerHTML = `
          ${logo}
          ...
          <div class="dev-card__body">
            ...
            <div class="dev-card__launches">
              ...
              <ul>${launches}</ul>
              <p class="dev-card__pricing" data-i18n="dev.pricing">Indicative starting prices &amp; payment plans — confirm the latest with Deluxe Homes.</p>
